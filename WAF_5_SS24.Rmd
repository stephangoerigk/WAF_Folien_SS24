...
```{r eval = TRUE, echo = F, out.width="55%", fig.align='center'}
knitr::include_graphics("bilder/prereg_einheit5.png")
```
...
```{r eval = TRUE, echo = F, out.width="55%", fig.align='center'}
knitr::include_graphics("bilder/prereg_einheit5_2.png")
```
...
```{r eval = TRUE, echo = F, out.width="55%", fig.align='center'}
knitr::include_graphics("bilder/prereg_einheit5_3.png")
```
...
```{r eval = TRUE, echo = F, out.width="55%", fig.align='center'}
knitr::include_graphics("bilder/prereg_einheit5_4.png")
```
...
```{r eval = TRUE, echo = F, out.width="55%", fig.align='center'}
knitr::include_graphics("bilder/prereg_einheit5_5.png")
```
...
```{r eval = TRUE, echo = F, out.width="100%", fig.align='center'}
knitr::include_graphics("bilder/bewertung_5.png")
```
